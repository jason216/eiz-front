...
@Component({
  ...
  selector: 'eparcel-consignments',
  templateUrl: './eparcel.consignments.component.html',
  styleUrls: ['./eparcel.consignments.component.scss'],
  animations: fuseAnimations
})
export class EparcelConsignmentsComponent implements OnInit, OnDestroy {
          ...
          this.consignmentsSubscription = this.activeContentService.onConsignmentsChange.subscribe(
            (consignments) => {
              if (consignments.eparcel) {
                this.consignments = consignments.eparcel;
                this.gridOptions.api.setRowData(consignments.eparcel[this.currentConsignments]);
                if (consignments.eparcel['pending']) {
                  this.Pending = consignments.eparcel['pending'].length;
                  this.Solid = consignments.eparcel['solid'].length;
                  this.Printed = consignments.eparcel['printed'].length;
