...
@Component({
  ...
  selector: 'consignments-pending',
  templateUrl: './consignments-pending.component.html',
  styleUrls: ['./consignments-pending.component.scss'],
  providers: [
    ConsignmentsService,
  ],
})
export class ConsignmentsPendingComponent implements OnInit, OnDestroy {
  consignments;
